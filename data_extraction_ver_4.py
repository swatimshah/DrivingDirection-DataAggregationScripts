...
file = mne.io.read_raw_eeglab("Participant10_Part6_SelectData.set")
...
numpy.savetxt('decimated_input_data_with_labels_10_6_800_1800.csv', final_input_data_with_labels, delimiter=',')	
