...
file = mne.io.read_raw_eeglab("Participant9_Part5_SelectData.set")
...
combined_events_and_labels = numpy.append(annot_filtered, my_labels.reshape(3, 91).transpose(), axis=1)
...
numpy.savetxt('decimated_input_data_with_labels_9_5_800_1800.csv', final_input_data_with_labels, delimiter=',')	
